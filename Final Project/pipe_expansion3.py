...
Ti = numpy.ones(nr)*(Tins-32)*5/9 + 274.15# Initial Temperature array converted to deg C
...
L = numpy.ones(nr)*L0 #Initalizes array for lengths
#dL = numpy.zeros(nr)
...
Lexp = Lexp/ft2m
print (Lexp[nr-1]-L[nr-1]/ft2m)*12
...
plt.plot(T, Lexp, color='#003366', ls='-', lw=3)
plt.ylim(Lexp[0]*.999,Lexp[nr-1]*1.001)
